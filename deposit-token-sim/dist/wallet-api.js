...
router.get('/accounts/:account', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (wallet) {
            ...
            else if (ethers_1.ethers.utils.isAddress(account)) {
        ...
        if (isRegistered) {
            try {
                const accountData = yield readWallet.contract.accounts(userAddress);
...
router.post('/accounts/:account/register', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const isAlreadyRegistered = yield wallet.contract.isRegistered(userAddress);
        ...
        const bankResponse = yield axios_1.default.post(`${BANK_SERVER_URL}/bank/register`, {
            address: userAddress
        });
        ...
        const bankWallet = new ethers_1.ethers.Wallet(bankPrivateKey, wallet.provider);
        ...
        const tx = yield bankContract.registerUser(userAddress, bankSponsor);
        ...
        if (error.code === 'CALL_EXCEPTION') {
            ...
            errorDetails = ((_a = error.response.data) === null || _a === void 0 ? void 0 : _a.error) || error.response.statusText;
        }
        res.status(500).json({
            error: errorMessage,
...
router.post('/accounts/:account/transfer', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const isRegistered = yield wallet.contract.isRegistered(userAddress);
        if (!isRegistered) {
            return res.status(400).json({ error: 'Account must be registered before making transfers' });
        }
        // Check if recipient is registered
        const isRecipientRegistered = yield wallet.contract.isRegistered(recipient);
        ...
        const authResponse = yield axios_1.default.post(`${BANK_SERVER_URL}${authEndpoint}`, authRequest);
        ...
        const tx = yield wallet.contract[transferFunction](recipient, amountWei, signedAuth);
        console.log(`Transaction submitted: ${tx.hash}`);
...
router.get('/contract/info', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        res.json({
            ...
            owner,
            rpcUrl: RPC_URL,
            networkId: yield wallet.provider.getNetwork().then(n => n.chainId),
            blockNumber: yield wallet.provider.getBlockNumber()
        });
    }
    catch (error) {
...
router.post('/accounts/:account/mint', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { account } = req.params;
        ...
        const tx = yield wallet.contract.mint(userAddress, amountWei);
        const receipt = yield tx.wait();
...
// Get account nonce
router.get('/accounts/:account/nonce', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { account } = req.params;
        let userAddress;
        // Check if it's a demo account
